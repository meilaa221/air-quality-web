    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-4 font-medium">Memuat data harian...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Statistik kualitas udara per hari
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-sm text-gray-500">Rata-rata Suhu</span>
            </div>
            <p className="text-3xl font-bold text-gray-800">
              {(stats.reduce((acc, s) => acc + (s.avgTemperature || 0), 0) / stats.length).toFixed(1)}°C
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-sm text-gray-500">Rata-rata Kelembaban</span>
            </div>
            <p className="text-3xl font-bold text-gray-800">
              {(stats.reduce((acc, s) => acc + (s.avgHumidity || 0), 0) / stats.length).toFixed(1)}%
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-sm text-gray-500">Total Deteksi Gerakan</span>
            </div>
            <p className="text-3xl font-bold text-gray-800">
              {stats.reduce((acc, s) => acc + s.motionCount, 0)}
            </p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">PPM Harian</h3>
          <div className="h-72">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="p-6 border-b border-gray-100">
          <h3 className="text-lg font-semibold text-gray-800">Detail Harian</h3>
        </div>
